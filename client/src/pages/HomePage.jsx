    ...
    <>
      ...
      <main className="min-h-screen grid grid-rows-3 gap-6 pt-16 px-40 text-white mt-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="col-span-1 flex flex-col items-center justify-center p-6 space-y-6 border border-white">
            <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl text-center">
              Napi <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">bónusz.</span>
            </h1>
            <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 text-justify w-full">
              Szerezd meg a napi <b>2$</b>-os bónusz jutalmadat! Minden 24 órában újra begyűjtheted ezt a bónuszt, ami hozzáadódik az egyenlegedhez!
            </p>
        ...
        <div className="flex items-center justify-center border border-white py-4 mb-15">
          <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Hírek</p>
        </div>
      </main>
      <footer>
        <Footer />
