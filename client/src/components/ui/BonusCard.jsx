...
<div className="relative h-50 max-w-sm p-8 bg-gradient-to-r from-blue-500 via-purple-600 to-red-600 border border-gray-200 rounded-lg shadow-xl overflow-hidden dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="absolute top-0 left-0 w-1/2 h-full opacity-30 transform translate-x-0">
        <svg className="w-35 h-35 text-gray-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="absolute top-4 right-4 text-white transform scale-150">
